            ...
            <div className="heading-section style-2 mb-40">
              <div className="left">
                ...
                <h3 className="title-section text-anime-wave">
                  Nuestros sectores de actividad son...
                </h3>
              </div>
            ...
            <div className="process-item step-hover">
              ...
              <div className="process-content">
                ...
                <div className="desc wow fadeInUp">
                  Mejora de la eficiencia hídrica de redes de agua potable y control de caudales de captación y retorno.
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="process-item step-hover">
              ...
              <div className="process-content">
                ...
                <div className="desc wow fadeInUp" data-wow-delay=".1s">
                  Supervisión de las masas de agua superficiales y subterráneas.
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="process-item step-hover">
              ...
              <div className="process-content">
                ...
                <div className="desc wow fadeInUp" data-wow-delay=".2s">
                  Evolución mareal y efectos del cambio climático.
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="process-item step-hover">
              ...
              <div className="process-content">
                <h5 className="wow fadeInUp" data-wow-delay=".3s">
                  <a href="#" className="name-process">
                    Sanidad pública y edificios de alta afluencia
                  </a>
                </h5>
                <div className="desc wow fadeInUp" data-wow-delay=".3s">
                  Prevención de proliferación de Legionela en redes ACS.
                </div>
              </div>
            </div>
          </div>
