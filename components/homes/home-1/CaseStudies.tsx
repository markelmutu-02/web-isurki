    ...
    >
          ...
          <div className="col-12">
            <div className="heading-section style-color-white text-center">
              ...
              <div className="sub-title body-2 text-anime-wave-1">
                Descubre como hemos ayudado clientes a conseguir resultados eficaces.
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="tf-container d-lg-none">
        <Swiper
          ...
          spaceBetween={16}
          modules={[Pagination]}
          pagination={{ clickable: true, el: ".case-studies-mobile-pagination" }}
        >
          {projects.map((project, index) => (
        ...
        <div className="sw-pagination-layout flex justify-content-center case-studies-mobile-pagination" />
      </div>
    </section>
  );
}
