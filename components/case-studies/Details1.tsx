          ...
          <div className="case-studies-details">
            ...
            <div className="detalis-content mb-40">
              ...
              <div className="desc mb-20 body-2">
                Asegurar las condiciones necesarias para controlar la proliferación de Legionela en los circuitos de ACS de 5 edificios hospitalarios del Hosp. Universitario Donostia.
              </div>
            </div>
            <div className="detalis-content mb-40">
              <h4 className="title-content mb-16">Solución</h4>
              <div className="desc mb-20 body-2">
                Despliegue de una red LoRa compuesta por 2 gateways y 36 nodos basados en dataloggers IsurLog gestionables desde una plataforma en la nube con mediciones de temperatura y caudal en cada uno de los puntos críticos de la red. Actuación sobre las válvulas termostáticas para regular automáticamente la temperatura óptima de cada ramal.
              </div>
            </div>
            <div className="detalis-content mb-40">
              <h4 className="title-content mb-16">La opinión del cliente</h4>
              <div className="desc mb-20 body-2">
                "La implantación del sistema de control de la red de agua caliente basado en la solución IRIS & ISURLOG ECOSYSTEM de ISURKI nos ha permitido detectar de forma efectiva cualquier escenario indeseable que pueda favorecer la proliferación de Legionela en nuestra red ACS y optimizar la gestión de las instalaciones técnicas afectadas". Daniel López Ortiz, Ingeniero en el Dpto. de Proyectos e Infraestructuras OSAKIDETZA – OSI DONOSTIALDEA
              </div>
            </div>
