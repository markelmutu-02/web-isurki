          ...
          <div className="case-studies-details">
            ...
            <div className="detalis-content mb-40">
              ...
              <div className="desc mb-16 body-2">
                Control de temperatura en almacenamiento refrigerado de medicamentos y vacunas.
              </div>
            </div>
            <div className="detalis-content mb-40">
              <h4 className="title-content mb-16">Problemática</h4>
              <div className="desc mb-20 body-2">
                Los departamentos de farmacia de los hospitales y centros de salud requieren asegurar la trazabilidad de la temperatura en las salas y dispositivos de almacenamiento, sensibles a cortes en el suministro eléctrico que pueden provocar el deterioro irreversible de los medicamentos y vacunas almacenadas. En estos casos, resulta crítico informar inmediatamente y con la antelación necesaria al personal responsable de cualquier escenario que pueda poner en riesgo la integridad del stock.
              </div>
            </div>
            <div className="detalis-content mb-40">
              ...
              <div className="desc mb-20 body-2">
                ...
                gestionables desde una plataforma en la nube con mediciones de temperatura en cada uno de los puntos de almacenamiento (locales de farmacia y frigoríficos).
              </div>
            </div>
