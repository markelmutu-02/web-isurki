          ...
          <div className="case-studies-details">
            <div className="image-details image mb-40">
              <Image
                ...
                alt="Diagrama de la red de mareógrafos para AZTI"
                className="lazyload"
                width={850}
                height={512}
              />
            ...
            <div className="detalis-content mb-40">
              ...
              <div className="desc mb-16 body-2">
                Registro de la evolución de la altura de marea y agitación del espejo de agua en estuarios y puertos marítimos.
              </div>
            </div>
            <div className="detalis-content mb-40">
              <h4 className="title-content mb-16">Problemática</h4>
              <div className="desc mb-20 body-2">
                Los investigadores del centro de investigación oceanográfica del País Vasco AZTI necesitaban analizar los datos en tiempo real, así como su evolución temporal del nivel del mar en tres parámetros significativos: <br/>
                        ◦ Marea astronómica.<br/>
                        ◦ Marea meteorológica.<br/>
                        ◦ Agitación en el puerto.<br/>
                El objetivo era prever y advertir sobre escenarios indeseados de atraque y operaciones piloto dentro del puerto, mejorando la comprensión del efecto que los parámetros mencionados tienen en la seguridad, operación y navegación del puerto interior. La recopilación de datos centrada en determinar comportamientos del nivel del mar permite la caracterización del riesgo de inundación costera en base a los datos obtenidos.
              </div>
            </div>
            <div className="detalis-content mb-40">
              ...
              <div className="desc mb-20 body-2">
                ...
                con conexión NB-IoT y datos en la nube mediante la plataforma{" "}
                <Link
                  href="/isurdash"
                  style={{ color: "var(--primary)", textDecoration: "underline" }}
                >
