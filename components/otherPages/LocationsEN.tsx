"use client";
import { officesEN } from "@/data/locationsEN";
import Image from "next/image";
import React from "react";
import { Swiper, SwiperSlide } from "swiper/react";

function OfficeCard({ office }: { office: (typeof officesEN)[number] }) {
  return (
...
export default function LocationsEN() {
  const hasMultipleOffices = officesEN.length > 1;
