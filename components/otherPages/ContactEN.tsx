...
import ContactForm from "./ContactFormEN";
              ...
              <div className="section-content">
                <div className="heading-section mb-28">
                  ...
                  <div className="sub-title body-2 color-on-suface-container wow fadeInUp">
                    Contact us today and tell us what you need. Our team is
                    ready to answer your questions, offer you the most suitable solution and support you from the very first moment.
                  ...
                  <div className="benefit-lists item">
                    ...
                    <div className="benefit-items">
                      ...
                      <div
                        ...
                        data-wow-delay=".1s"
                      >
                        Talk to us before deciding, at no cost
                      </div>
                    </div>
                  </div>
                  <div className="benefit-lists item">
