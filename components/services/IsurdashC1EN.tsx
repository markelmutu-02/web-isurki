            ...
            <div className="section-content">
              <div className="heading-section">
                ...
                <div className="sub-title body-2 text-anime-wave">
                  Summary map offering visual information on the status of each station, taking into account the connection status and the battery level of each one.
                </div>
              </div>
          ...
          <div className="col-lg-6">
            <div className="image tf-animate-4">
              <Image
                ...
                alt="Station summary map in IsurDash"
                className="lazyload"
                width={615}
                height={615}
              />
