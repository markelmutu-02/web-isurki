              ...
              <div className="heading-section">
                <div className="wow fadeInUp">
                  <a href="#" className="tag label text-btn-uppercase">
                    Orientación de Isurlog
                  </a>
                </div>
                
                <div className="sub-title body-2 wow fadeInUp">
                  Gracias al acelerómetro integrado de las Isurlog, es posible saber la orientación exacta de la Isurlog, e IsurDash es capaz de enseñarlo en una representación 3D y ofrecer un histórico
                </div>
              </div>
