          ...
          <div className="col-lg-6">
            <div className="image mr-15 tf-animate-1">
              <Image
                ...
                alt="LoRa and NB-IoT coverage information in IsurDash"
                className="lazyload"
                width={615}
                height={615}
              />
              ...
              <div className="heading-section">
                <div className="wow fadeInUp">
                  <a href="#" className="tag label text-btn-uppercase">
                    Isurlog coverage information
                  </a>
                </div>

                <div className="sub-title body-2 wow fadeInUp">
                  IsurDash provides coverage information for both LoRa and NB-IoT devices, together with a history to see coverage over time
                </div>
              </div>
