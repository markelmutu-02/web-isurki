              ...
              <div className="heading-section">
                <div className="wow fadeInUp">
                  <a href="#" className="tag label text-btn-uppercase">
                    Consola MicroPython REPL
                  </a>
                </div>
                
                <div className="sub-title body-2 wow fadeInUp">
                  Consola MicroPython REPL para ejecutar comandos python en la Isurlog conectándose mediante USB (serial port) o remotamente en el caso de las NB-IoT.
                </div>
              </div>
